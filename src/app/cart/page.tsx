  ...
  if (items.length === 0) {
    return (
      <div className="py-28 text-center">
        ...
        <Link href="/catalog" className="mt-6 inline-flex items-center px-6 py-3 bg-dark hover:bg-gold text-light text-sm font-medium tracking-wider uppercase transition-all duration-300">Каталог</Link>
      </div>
    );
  }
    ...
    <div className="py-12 lg:py-20 min-h-screen">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-light-border">
          {items.map((item) => (
            <div key={item.id} className="py-6 border-b border-light-border flex gap-4">
