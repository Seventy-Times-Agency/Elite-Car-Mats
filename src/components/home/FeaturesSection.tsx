...
const features = [
  {
    ...
    title: "Fit for your VIN range",
    desc: "290+ models with precision patterns by year. No gaps, no pedal interference — guaranteed fit.",
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-7 h-7">
    ...
    title: "CNC-cut ±1 mm",
    desc: "Plotter-cut from a digital pattern — not eyeballed with cardboard templates. Identical fit in every pair.",
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-7 h-7">
    ...
    title: "Made to order",
    desc: "Your set doesn't sit on a shelf — we start cutting after payment. 48 hours from order to shipment.",
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-7 h-7">
    ...
    desc: "Covers material and stitching. Cracked or warped? We replace it free — no paperwork, no inspections.",
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-7 h-7">
    ...
    title: "Odor-free",
    desc: "EVA doesn't smell like rubber and emits no VOCs. REACH-compliant — safe for cars with kids.",
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-7 h-7">
    ...
    title: "Free shipping",
    desc: "USPS / UPS Ground anywhere in the USA on orders over $99. 2–3 day express shipping for $19.",
  },
];
    ...
    <section className="py-14 lg:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <Reveal className="text-center mb-10">
          ...
          <h2 className="mt-4 text-3xl lg:text-4xl font-bold">Why Elite Car Mats</h2>
