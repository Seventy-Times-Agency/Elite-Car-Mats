...
const steps = [
  {
    ...
    desc: "Tell us your make, model, and year — our configurator instantly pulls the matching pattern from our library of 290+ vehicles.",
    icon: (
  ...
  {
    n: "02",
    title: "Precision CNC cut",
    desc: "Our CNC plotter cuts the EVA sheet along the 3D template with ±1 mm accuracy. Every mat mirrors the exact floor contour of your car.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-8 h-8">
  ...
  },
  {
    ...
    desc: "The edging is double-stitched with high-tensile thread, a badge with your car's logo is set, and an ELITECARMATS.US tag is sewn on the side.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-8 h-8">
  ...
  },
  {
    ...
    desc: "Packed in a heavy kraft mailer and shipped via USPS or UPS Ground within 48 hours. Free shipping on orders over $99.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-8 h-8">
    ...
    <section className="py-14 lg:py-20 relative">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <Reveal className="text-center mb-10">
          ...
          <h2 className="mt-4 text-3xl lg:text-4xl font-bold">How we build your set</h2>
