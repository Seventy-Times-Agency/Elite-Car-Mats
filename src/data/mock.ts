...
export const mockModels: CarModel[] = [
  ...
  m("rs6","audi","Audi","RS6","rs6",Y(2013,2025),"Универсал"),
  ...
  // Chevrolet
  m("silverado","chevrolet","Chevrolet","Silverado","silverado",Y(1999,2025),"Пикап"),
  ...
  m("forte","kia","Kia","Forte","forte",Y(2010,2025),"Седан"),
  ...
  m("mx-5","mazda","Mazda","MX-5","mx-5",Y(1990,2025),"Родстер"),
  // Mercedes-Benz
  ...
  m("venza","toyota","Toyota","Venza","venza",Y(2009,2015),"Кроссовер"),
  ...
  m("golf","volkswagen","Volkswagen","Golf","golf",Y(1990,2025),"Хэтчбек"),
  // Volvo
