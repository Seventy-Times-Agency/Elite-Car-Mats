...
export const en: Dict = {
  ...
  "blog.ctaTagline":
    "Ready for premium EVA mats cut for your exact car?",
  ...
  "track.errAuth": "Open the link from your confirmation email, or sign in below with the email you used at checkout.",
  ...
  "admin.catalogConfirmDeleteBrand":
    "Delete \"{name}\" and its {n} models? This can't be undone.",
  ...
  "admin.catalogErrSlugReserved":
    "That slug is used by a code-based brand and can't be reused.",
  ...
  "admin.catalogErrYears":
    "Years must be a comma-separated list of 4-digit years.",
  "admin.catalogErrSave": "Could not save.",

  "admin.blogTitle": "Blog",
  "admin.blogSubtitle": "Markdown posts. Newest first; drafts are hidden from /blog until published.",
