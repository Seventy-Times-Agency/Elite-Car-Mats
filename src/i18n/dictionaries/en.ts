...
export const en: Dict = {
  ...
  "admin.pricingSubtitle":
    "Read-only snapshot of the live price table. Edit src/data/catalog/mat-sets.ts to change prices and redeploy.",
  "admin.pricingNoticeH": "Heads up",
  "admin.pricingNoticeP":
    "These prices live in code, not in the database. Until in-place editing ships, prices change in",
  "admin.pricingColType": "Type",
  "admin.pricingColLabel": "Label",
  "admin.pricingColPrice": "Price",
