...
export const en: Dict = {
  ...
  "prod.stepSet": "2 — Set",
  "prod.stepColor": "3 — Mat color: {color}",
  "prod.stepEdge": "4 — Edge: {color}",
  ...
  "comparison.row1Ours": "1 mm (CNC-cut from 3D pattern)",
  ...
  "comparison.row8Ours": "4 edge colors, brand badge",
  ...
  "contacts.ogDesc":
    "info@elitecarmats.us · Rochester, NY · Nationwide U.S. shipping.",
  ...
  "delivery.t1": "up to 48 hours after payment",
  "delivery.t2Pre": "USPS / UPS Ground:",
  "delivery.t2": "3–7 business days within the U.S.",
  "delivery.t3Pre": "Express (UPS 2nd Day):",
  "delivery.t3": "2–3 business days — $19",
  "delivery.costH": "Cost",
  "delivery.c1Pre": "Free",
  "delivery.c1": "on orders over $99 (standard shipping)",
  "delivery.c2": "$9 USPS / UPS Ground on orders under $99",
  ...
  "warranty.c3":
    "EVA cracking within the normal temperature range (−40°F to 160°F)",
  ...
  "warranty.h2Post":
    " with the subject \"Warranty\" and your order number",
  "warranty.h3": "Attach the photos and describe when the issue appeared",
  "warranty.h4": "We respond within 1 business day",
  "warranty.h5":
    "If the defect is confirmed, we produce and ship a replacement at no cost",
  ...
  "refund.windowPPost":
    " from the delivery date to decide whether to keep or return your mats.",
  ...
  "refund.howPre": "Email",
  "refund.howPost":
    " with the subject \"Return\" and your order number",
  ...
  "refund.how4":
    "Once we receive the package, we'll refund you within 5 business days",
  ...
  "refund.who2":
    " — customer covers return shipping (~$10–15 USPS Ground)",
  ...
  "refund.not2":
    "Custom-designed mats produced outside our standard catalog",
  ...
  "refund.damagePPost":
    ". We'll replace it free or refund the full amount.",

  // Privacy
  "privacy.metaTitle": "Privacy Policy",
  "privacy.metaDesc":
    "How Elite Car Mats collects, uses, and protects your personal data.",
  ...
  "terms.s5PPre":
    "2 years on materials and stitching. Full details on the ",
  ...
  "email.matSetFront": "Fronts",
  "email.matSetFull": "Full Set",
  "email.matSetCargo": "Cargo",
  "email.matSetFullCargo": "Full Set + Cargo",
