...
export const storefront: Dict = {
  ...
  "footer.phoneNote": "Any question — orders, returns, sizing. Call or WhatsApp.",
  ...
  "contacts.phoneNote": "One call solves it — place an order, arrange a return, ask anything.",
  "contacts.whatsappNote": "Same number on WhatsApp — text us anytime.",
